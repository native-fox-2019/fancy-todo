...
| No | API                                     	| Description |
| --- | -------------------------------------- 	| ----------- |
| 1.  | node-mailjet                       		| Untuk Mengirim Pemberitahuan bahwa email anda telah terdaftar beserta mengirim password ketika register dari google|
