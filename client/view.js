  ...
  data.forEach((el) => {
    ...
    <td>
      <div class="btn-group" role="group" aria-label="Basic example">
        <button type="button" class="btn btn-secondary" id="editTodos" onclick="getTodosbyId(${el.id})">Edit</button>
...
// function getEditTodos(data) {
//   console.log(data, '<<<<<<<<< dari request')
//   console.log(data.title, '<<<<<<<<< dari request')
  // titleEdit
  // descriptionEdit
  // statusEdit
  // due_dateEdit
